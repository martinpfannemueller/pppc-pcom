 ...
 */
public class PowerpointProxy extends info.pppc.pcom.system.container.internal.component.InstanceProxy implements info.pppc.pcom.component.powerpoint.IPowerpoint {
	
	/**
	 * Default constructor to create a new object.
	 */
	public PowerpointProxy() { }
	 ...
	 * Proxy method that creates and transfers an invocation for the interface method.
	 *
	 * @throws java.lang.IllegalStateException see info.pppc.pcom.component.powerpoint.IPowerpoint
	 * @throws info.pppc.base.system.InvocationException see info.pppc.pcom.component.powerpoint.IPowerpoint
	 * @see info.pppc.pcom.component.powerpoint.IPowerpoint
	 */
	public void nextSlide() throws java.lang.IllegalStateException, info.pppc.base.system.InvocationException {
		Object[] __args = new Object[0];
		String __method = "void nextSlide()";
		info.pppc.base.system.Invocation __invocation = __create(__method, __args);
		info.pppc.base.system.Result __result = __invoke(__invocation);
		if (__result.hasException()) {
	 ...
	 * @see info.pppc.pcom.component.powerpoint.IPowerpoint
	 */
	public void previousSlide() throws java.lang.IllegalStateException, info.pppc.base.system.InvocationException {
		Object[] __args = new Object[0];
		String __method = "void previousSlide()";
		info.pppc.base.system.Invocation __invocation = __create(__method, __args);
		info.pppc.base.system.Result __result = __invoke(__invocation);
		if (__result.hasException()) {
			if (__result.getException() instanceof java.lang.IllegalStateException) {
	 ...
	 * Proxy method that creates and transfers an invocation for the interface method.
	 *
	 * @return seeinfo.pppc.pcom.component.powerpoint.IPowerpoint
	 * @throws java.lang.IllegalStateException see info.pppc.pcom.component.powerpoint.IPowerpoint
	 * @throws info.pppc.base.system.InvocationException see info.pppc.pcom.component.powerpoint.IPowerpoint
	 * @see info.pppc.pcom.component.powerpoint.IPowerpoint
	 */
	public int getSlide() throws java.lang.IllegalStateException, info.pppc.base.system.InvocationException {
		Object[] __args = new Object[0];
		String __method = "int getSlide()";
		info.pppc.base.system.Invocation __invocation = __create(__method, __args);
		info.pppc.base.system.Result __result = __invoke(__invocation);
		if (__result.hasException()) {
			if (__result.getException() instanceof java.lang.IllegalStateException) {
	 ...
	 * @see info.pppc.pcom.component.powerpoint.IPowerpoint
	 */
	public void firstSlide() throws java.lang.IllegalStateException, info.pppc.base.system.InvocationException {
		Object[] __args = new Object[0];
		String __method = "void firstSlide()";
		info.pppc.base.system.Invocation __invocation = __create(__method, __args);
		info.pppc.base.system.Result __result = __invoke(__invocation);
		if (__result.hasException()) {
			if (__result.getException() instanceof java.lang.IllegalStateException) {
	 ...
	 * @see info.pppc.pcom.component.powerpoint.IPowerpoint
	 */
	public void lastSlide() throws java.lang.IllegalStateException, info.pppc.base.system.InvocationException {
		Object[] __args = new Object[0];
		String __method = "void lastSlide()";
		info.pppc.base.system.Invocation __invocation = __create(__method, __args);
		info.pppc.base.system.Result __result = __invoke(__invocation);
		if (__result.hasException()) {
			if (__result.getException() instanceof java.lang.IllegalStateException) {
	 ...
	 * Proxy method that creates and transfers an invocation for the interface method.
	 *
	 * @param slide see info.pppc.pcom.component.powerpoint.IPowerpoint
	 * @throws java.lang.IllegalArgumentException see info.pppc.pcom.component.powerpoint.IPowerpoint
	 * @throws java.lang.IllegalStateException see info.pppc.pcom.component.powerpoint.IPowerpoint
	 * @throws info.pppc.base.system.InvocationException see info.pppc.pcom.component.powerpoint.IPowerpoint
	 * @see info.pppc.pcom.component.powerpoint.IPowerpoint
	 */
	public void setSlide(int slide) throws java.lang.IllegalArgumentException, java.lang.IllegalStateException, info.pppc.base.system.InvocationException {
		Object[] __args = new Object[1];
		__args[0] = new Integer(slide);
		String __method = "void setSlide(int)";
		info.pppc.base.system.Invocation __invocation = __create(__method, __args);
		info.pppc.base.system.Result __result = __invoke(__invocation);
		if (__result.hasException()) {
			if (__result.getException() instanceof java.lang.IllegalArgumentException) {
