...
import info.pppc.pcom.component.filesystem.DebugFilesystemSkeleton;
 ...
 * @author Mac
 */
public class DebugFilesystemFactory implements info.pppc.pcom.system.model.component.IFactory {
	...
	public IInstance createInstance() {
		return new DebugFilesystemInstance(this);
	}
	...
	public IInstanceSkeleton createSkeleton() {
		return new DebugFilesystemSkeleton();
	}
