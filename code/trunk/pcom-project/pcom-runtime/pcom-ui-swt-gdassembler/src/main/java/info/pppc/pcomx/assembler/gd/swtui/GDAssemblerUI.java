package info.pppc.pcomx.assembler.gd.swtui;

import info.pppc.base.swtui.Application;
import info.pppc.base.system.util.Logging;
import info.pppc.pcom.swtui.PcomUI;
import info.pppc.pcomx.assembler.gd.swtui.action.AssemblerAction;
 ...
 * @author Mac
 */
public class GDAssemblerUI {
	
	/**
	 * The image shown for the gc visualizer action.
	 */
	public static final String IMAGE_GD = "GD";
	...
	private static ResourceBundle getResourceBundle() {
		if (resourceBundle == null) {
			resourceBundle = ResourceBundle.getBundle("info/pppc/pcomx/assembler/gd/swtui/resource/text");
		}
	...
	public static void loadImage(String key, String image) {
		getImageRegistry().put(key, ImageDescriptor.createFromURL
			(GDAssemblerUI.class.getResource("resource/" + image)));
	}
}
