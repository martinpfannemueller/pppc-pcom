...
/**
 * The save action saves an application using a control and a descriptor.
 * 
 * @author Mac
 */
public class SaveAction extends Action {
	 ...
	 */
	private static String UI_TEXT = "info.pppc.pcom.swtui.application.action.SaveAction.TEXT";
	 ...
	 */
	public SaveAction(ApplicationControl control, ApplicationDescriptor descriptor) {
		super(PcomUI.getText(UI_TEXT), BaseUI.getDescriptor(BaseUI.IMAGE_RIGHT));
	 ...
	 */
	public void run() {
		control.saveApplication(descriptor);
	}
